<div class="container-fluid">
    <div class="col-md-12">
        <h4 class="my-3"><span style="border-bottom:1px solid black">Accommodation</span></h4>
    </div>
...
<script>
    $(document).ready(function(){
        $("#Go").click(function(){
            ...
            $.ajax({
                url: '<?php echo base_url("Admin/DeleteAccommodation/Showaccomodationentry"); ?>',
                type: 'POST',
                data: {data: demo},
                dataType: 'json',
    ...
    $.ajax({
        url: '<?php echo base_url("Admin/Accommodation/UpdateAccommodationData"); ?>',
        type: 'POST',
        data: { data: inputData },
        success: function (response) {
            if(response == '1'){
    ...
    var entryId = $(this).data("meta");
       console.log(entryId);
    $.ajax({
        url: '<?php echo base_url("Admin/DeleteAccommodation/Removeentry"); ?>',
        type: 'POST',
        data: { id: entryId }, // Sending the 'id' instead of 'data'
        success: function (response) {
            if (response == '1') {
                Swal.fire({
                    icon: 'success',
