...
<div class="container-fluid ">
    <div class="row p-2">
        <div class="col-md-12">
           ...
           <h3 style="font-weight: bold;color: #343333;" class="mt-1">
            <spam style="color:red;"><a class="text-danger " href="#" contenteditable="false" style="cursor: pointer;"></a> Register as a TTJ TRAVMART  </spam>  Buyer
        </h3> 
    ...
    <ul>
        <li>  Only B2C Travel agents and Tour Operators can register as buyers.</li>
        <li>  Your Registration in our buyers programme is subject to our review.</li>
        <li>  Hosted Buyer registrations and FAM Tour options are available to Club TTJ Members.</li>
    </ul>
        </div>
...
$(document).ready(function() {
    ...
    $(document).ready(function() {
        $("#buyerForm").submit(function(e) {
            ...
            $.ajax({
                url: '<?= base_url() ?>Buyer_Registration/Submit_the_buyer_form',
                type: 'post',
                data: formData,
                processData: false,
                contentType: false,
