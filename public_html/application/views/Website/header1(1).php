         ...
         <div class="col-md-3 col-sm-6 col-6">
             <picture>
                    <source>
                     ...
                     <?php
                             echo  '<p class="p-0 m-0" style="font-size: 14px;font-weight: 900;">'.$event_count->EventPlace.'</p>';
                             echo  '<span class="p-0 m-0">'. $event_count->Location .'</span>'; 
                     ?>
                     </div>
                    </source>
      ...
      <div class="col-md-1 col-sm-12 col-12 d-md-block d-sm-none d-none"></div> 
           ...
           <div class="col-md-2 col-sm-12 col-12 d-md-block d-sm-none d-none">
             ...
             <picture>
                    ...
                    <source>
                     <img class="d-inline-block  logo-1" src="https://traveltradejournal.com/wp-content/uploads/2022/08/TTJ-Logo-PNG-e1661531371256.png" alt="TTJ Logo" aria-label="Logo">
              </source>
         ...
         <div class="col-md-2 col-sm-12 col-12 d-md-block d-sm-none d-none" >
             ...
             <picture>
                    ...
                    <source>
                   <img class="d-inline-block logo-1 " src="https://sampantech.com/assets/imgs/logo11.png" alt="sampantech" aria-label="Logo">
             </source>
              </picture>
          </div>
         </div>
         ...
         <div class="col-md-1 col-sm-12 col-12 d-md-block d-sm-none d-none"></div> 
           ...
           <div class="col-md-2 col-sm-12 col-12 d-md-block d-sm-none d-none">
             ...
             <picture>
                    <source>
                   <img class="d-inline-block  logo-1 " src="<?php echo base_url() ?>assets/marketplace/Logo_2.png  " alt="marketplace" aria-label="Logo">
             </source>
              </picture>
           </div>
         </div>
         ...
         <div class="col-md-1 col-sm-6 col-6 display-nonee1">
           <div class="event-details-btn21">
            <a href="<?php echo base_url();?>Meeting/login"><button class="btn btn-colorful47"> Login</button></a>
            <a href="<?php echo base_url();?>Seller_Registration"><button class="btn btn-colorful45"> Seller</button></a>
            <a href="<?php echo base_url();?>Buyer_Registration"><button class="btn btn-colorful46"> Buyer</button></a>
            </div>
         </div> 
         ...
         <!--<div class="col-lg-2 col-md-2 col-sm-6 col-6 text-end">-->
         <!--   <div class="event-details-btn21">-->
         <!--    <a href=""><button class="btn btn-colorful45"> Seller</button></a>-->
         <!--   <a href=""><button class="btn btn-colorful46"> Buyer</button></a>-->
         <!--   </div>-->
...
<div class="navbar navbar-expand-lg navbar-dark nav-bg-home" style="position: sticky !important;top: -1px;background:black;border-bottom:1px solid white">
    <div class="container-fluid">
        <!--<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive"-->
        <!--        aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation" style="    background: white;color: white !important;">-->
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav">
                ...
                <!--    </a>-->
                <!--    <div class="dropdown-menu" aria-labelledby="navbarDropdown" id="header_div">-->
                <!--        <a class="dropdown-item" href="<?php echo base_url();?>Buyer_Registration">Hosted Buyer</a>-->
                <!--        <a class="dropdown-item" href="<?php echo base_url();?>Buyer_Registration">Non Hosted Buyer</a>-->
                <!--    </div>-->
                <!--</li>-->
                <!--<li class="nav-item dropdown">-->
                <!--    <a class="nav-link nav-link1 dropdown-toggle" id="navbarDropdown" role="button"-->
                ...
                <!--    </a>-->
                <!--    <div class="dropdown-menu" aria-labelledby="navbarDropdown" id="header_div">-->
                <!--        <a class="dropdown-item" href="#">Seller Profile</a>-->
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown" id="header_div">
                        ...
                        <a class="dropdown-item" href="<?php echo base_url();?>Market_Place_Buyer_Registration">Registered as a Buyer</a>
                        <a class="dropdown-item" href="<?php echo base_url();?>Market_place_Seller_Register">Registered as a Seller</a>
                    </div>
                </li>
                
                 <li class="nav-item dropdown">
                    <a class="nav-link nav-link1" href="<?php echo base_url();?>CludTTJ"> Club TTJ<span
                            class="caret"></span></a>
                </li>
