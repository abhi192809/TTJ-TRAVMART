...
<script>
    $(document).ready(function () {
        ...
        submitFormBtn.click(function () {
            ...
            $.ajax({
                url: "<?= base_url()?>/Meeting/Admin/Destionation/add_Food",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(".delete-btn").click(function () {
            ...
            $.ajax({
                url: "<?= base_url()?>/Meeting/Admin/Destionation/delete_Food", 
                type: "POST",
                data: { id: rowId },
                success: function (response) {
    ...
    Swal.fire({
        ...
        html: `
            <form id="updateForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="visitor_attraction">Food</label>
                    <input type="text" class="form-control" id="Food" name="Food" value="${row.Food}">
                </div>
                <div class="form-group">
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?= base_url()?>/Meeting/Admin/Destionation/update_Food",
                type: "POST",
                data: result.value,
                processData: false,
                contentType: false,
