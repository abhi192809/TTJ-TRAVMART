...
<div class="container-fluid">
  ...
  <!-------------end----------------->
    <div class="margtoppp-data-form card">
      <div class="table-responsive card-body">
           <div class=" col-md-12 col-sm-12 col-12">
            <a class="text-danger" href="<?php echo base_url();?>Meeting/Admin/Meeting_Details/filter/<?php echo $eventID ?>"><span class="share-btnnn"><i class="fa fa-share rotate-190" id="backButton"></i> Back</span></a><br> 
        </div>
          <div class="row">
   ...
   <?php if (!empty($Buyer_Data)) { $i = '1'; foreach ($Buyer_Data as $row): foreach($Event_Related_Buyer as $row_Related_Buyer): ?>
    <?php if ($row->id == $row_Related_Buyer->Buyer_ID AND $row_Related_Buyer->Attand_or_not ): ?>
        <tr>
            <td><?php echo $i; ?></td>
