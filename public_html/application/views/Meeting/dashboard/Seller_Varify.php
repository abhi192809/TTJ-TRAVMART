...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <option value="" > <?php echo @$Name->fullName ;?></option>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="hidden" class="form-control" id="sellerID" placeholder="" name="id" maxlength="30"  required value="<?= @$Seller_data->SellerID?>">
  <input type="Name" class="form-control" id="sellerName" placeholder="Seller's Name" name="sellerName" maxlength="30"  required value="<?= @$Seller_data->SellerName?>">
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="company" class="form-control" id="companyName" name="companyName" placeholder="Seller's Company Name" maxlength="30" value="<?= @$Seller_data->CompanyName?>" required>
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="tel" class="form-control" id="phoneNumber" name="phoneNumber" placeholder="Contact Information" maxlength="13" value="<?= @$Seller_data->PhoneNumber?>" required>
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="email" class="form-control" id="sellerEmail" name="sellerEmail" placeholder="Email" maxlength="30" value="<?= @$Seller_data->SellerEmail?>" required>
</div>
...
<div class="col-md-6 mb-3 d-flex align-items-center">
  ...
  <textarea class="form-control" id="physicalAddress" name="physicalAddress" placeholder="Physical Address" maxlength="100" required> <?= @$Seller_data->PhysicalAddress?> </textarea>
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="city" class="form-control" id="city" name="city" placeholder="City" maxlength="30"  value="<?= @$Seller_data->City?>" required>
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="city" class="form-control" id="country" name="country" placeholder="Country" maxlength="30"  value="<?= @$Seller_data->Country?>" required>
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="text" class="form-control" id="pinCode" name="pinCode" placeholder="Pin Code" value="<?= @$Seller_data->PinCode?>" required>
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="url" class="form-control" id="website" name="website" placeholder="Website" value="<?= @$Seller_data->Website ?>">
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="text" class="form-control" id="panNumber" placeholder="PAN Number" name="panNumber"  ng-model="abc" ng-pattern="panCardRegex"  title="Enter valid PAN number" value="<?= @$Seller_data->PanNumber ?>" required>
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="text" class="form-control" id="gstNumber" name="gstNumber" placeholder="GST Number:" title="Enter valid GST number" value="<?= @$Seller_data->GstNumber ?>" required>
</div>

<div class="col-md-3 mb-3 d-flex align-items-center text-center">
    <img src="<?php echo base_url();?>assets/Meeting/Seller_logo/<?= @$Seller_data->Logo ?>" width="50%">
    <label class="d-none" for="referenceId"><b>Logo</b></label>
    <input type="hidden" name="Logo" id="Logo" class="form-control d-none" accept=".png" style="color:black" value="<?= @$Seller_data->Logo ?>">
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  <label for="certifications">
   ...
   <input type="text" class="form-control" id="certifications" name="certifications" placeholder="License and Certifications" value="<?= @$Seller_data->Certifications ?>" required>
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="number" class="form-control" id="yearsInOperation" name="yearsInOperation" placeholder="Years in Operation"  value="<?= @$Seller_data->YearsInOperation ?>" required>
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="text" class="form-control" id="industryExperience" name="industryExperience" placeholder="Industry Experience" value="<?= @$Seller_data->IndustryExperience ?>" required>
</div>
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="number" class="form-control" id="annualTurnover" placeholder="Annual Turnover (INR)" name="annualTurnover" value="<?= @$Seller_data->AnnualTurnover ?>" required>
</div>
<!-- Services Offered -->
...
<div class="col-md-3 mb-3 d-flex align-items-center">
  ...
  <input type="tel" class="form-control" id="emergencyContacts" name="emergencyContacts" placeholder="Emergency Contacts" value="<?= @$Seller_data->EmergencyContacts ?>" required>
</div>
...
<h3>Seller Wants to Enter this Event</h3>

<?php 
    $eventNames = $Seller_data->EventID;
    $eventNamesArray = explode(',', $eventNames); // Split the string by commas to create an array of event names
?>

<?php foreach($eventNamesArray as $eventName): ?>
    <span><?php echo trim($eventName); ?></span>, <!-- Trim removes any leading/trailing spaces -->
<?php endforeach; ?>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <script>
        ...
        function submitForm(formData) {
            $.ajax({
                type: "POST",
                url: "<?= base_url()?>Meeting/Admin/Seller/insertSellerApproved",
                data: formData,
                processData: false,
                contentType: false,
                    ...
                    if (response == 1) {
                        Swal.fire({
                            ...
                            confirmButtonText: 'OK'
                              ...
                              window.location.href = 'https://www.ttjtravmart.com/Meeting/Admin/Seller/Seller_request';
                        });
                    }
                },
