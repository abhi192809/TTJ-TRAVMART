...
<body>
    ...
    <div class="margtoppp-data-form card">
     <caption class="form-data-heading"><h4 class=""> <a class="text-danger" href="<?php echo  base_url() ?>/Meeting/Admin/seller/seller_data_view"><span class="share-btnnn"><i class="fa fa-share rotate-190" id="backButton"></i></span></a> Seller Event Data</h4> </caption> <hr>
        ...
        <?php foreach ($Event_Data as $Row_EventID): ?>
            <?php if ($Row_EventID->EventID == $Row_EventID_Map->event_id): ?>
                <tr>
                    ...
                    <td>35</td>
                    <td>
                        <a href="<?php echo base_url() ?>Meeting/Admin/Seller/Get_the_Seller_Realted_Event_Buyer_Meeting/<?php echo $Row_EventID->EventID ?>/<?php echo $id ?>" class="event-details-button btn-secondary btn-icon-split reload-link" title="View" contenteditable="false" style="cursor: pointer;">
                            <span class="icon">
