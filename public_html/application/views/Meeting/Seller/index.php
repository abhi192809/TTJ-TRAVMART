<style>
    ...
    <div class="dashboard1">
        ...
        <div class="section2">
            <h2> Event </h2>
            <p id="sellerCount"><?php echo $Event_Book ?></p>
        </div>
        </div>
       ...
       <div class="col-lg-3 col-md-6 col-sm-6 col-12"> 
        <div class="section3">
            ...
            <p id="eventsDone"><?php echo $Meeting_Done ?></p>
        </div>
        </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-12">
        <div class="section5">
            <h2> Event </h2>
            <p id="buyerCount"><?php echo $event->EventName ?></p>
        </div>
    </div>
    <?php endforeach; ?>
        ...
        <div class="section6">
            ...
            <p id="sellerCount"><?php echo $Meeting ?></p>
        </div>
        </div>
                        ...
                        <?php $i=1; foreach($Event as $row):?>
                            <?php if($row->EventStartDate > date('Y-m-d')):?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url();?>Meeting/Selleruser/bookmeeting/pre_booking_Event_seller" class="btn btn-danger">Book Event</a></td>
                                </tr>
                                <?php $i++; endif; ?>
                        <?php endforeach;?>
                    </tbody>
