...
<div id="sidebar">
    <h4 class="border-bottom">TTJ TRAVMART</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 nav_top text-end">
                <span> <a  href="<?php echo base_url()?>Admin/AdminLogin/logout" class="p-2 m-0 logout btn text-white" style="background:dimgrey">Logout</a></span>
