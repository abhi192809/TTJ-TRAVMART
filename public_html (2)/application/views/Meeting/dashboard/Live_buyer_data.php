  ...
  <!-------------end----------------->
   ...
   <?php if (!empty($Buyer_Data)) { $i = '1'; foreach ($Buyer_Data as $row): foreach($Event_Related_Buyer as $row_Related_Buyer): ?>
    <?php if ($row->id == $row_Related_Buyer->Buyer_ID  ): ?>
        <tr>
            <td><?php echo $i; ?></td>
            <td><?php echo @$Active_Event->EventName; ?></td>
            ...
            <td>
                <?php if($row_Related_Buyer->Attand_or_not == '1'){
                ?>
            ...
            <td><?php echo  $this->Buyer_model->get_meeting_buyer_live_Event($Active_Event->EventID,$row->id);?></td>
            <td class="view-details-btnn" style="display: flex; flex-direction: row;">
                ...
                <?php if($row_Related_Buyer->Attand_or_not == '0'){
                ?>
                <a href="#" onclick="VarifyData('<?php echo $row_Related_Buyer->Map_ID ?>')" class="btn-danger btn-icon-split  mx-1 " title="View">
                    <span class="icon">
