...
<a class="text-danger" href="<?php echo base_url();?>Meeting/Admin/Meeting_Details/filter/<?php echo $eventID ?>" contenteditable="false" style="cursor: pointer;"><span class="share-btnnn"><i class="fa fa-share rotate-190" id="backButton"></i> Back</span></a>
  <!-------------end----------------->
      ...
      <div class="table-responsive card-body">
          <div class="row">
             <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <caption class="form-data-heading  mb-4 "> <?php echo @$Active_Event->EventName?> </caption> 
                 </div>
            </div>
   ...
   <?php if (!empty($Seller_Data)) { $i = '1'; foreach ($Seller_Data as $row): foreach($Event_Related_Seller as $row_Related_Seller): ?>
    <?php if ($row->SellerID ==  $row_Related_Seller->seller_id  ): ?>
        <tr>
            <td><?php echo $i; ?></td>
