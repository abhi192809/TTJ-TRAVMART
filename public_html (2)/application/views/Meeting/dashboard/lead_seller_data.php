...
<div class="container-fluid">
  ...
  <table class="table mt-4" id="dataTable">
    ...
    <tbody>
      ...
      <?php foreach($get_seller as $seller_row):?>
      <?php foreach($get_buyer as $buyer_row):?>
      <?php if($seller_row->SellerID == $row->seller_ID  AND $buyer_row->id == $row->buyer_ID AND  $row->enquiry == 0 ):?>
      <tr>
        <td><?= $i ?></td>
        <td><?= $seller_row->CompanyName?></td>
