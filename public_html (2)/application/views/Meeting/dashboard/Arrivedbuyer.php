      ...
      <div class="table-responsive card-body">
          <div class="row">
             <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <caption class="form-data-heading  mb-4"> Active Buyer list</caption> 
                 </div>
            </div>
    ...
    foreach ($All_Event as $Event_Data) {
        foreach ($Event_Related_Buyer as $Related_Buyer) {
            foreach ($Buyer_Data as $Buyer) {
                if ($Buyer->id == $Related_Buyer->Buyer_ID && $Event_Data->EventID == $Related_Buyer->Evet_ID AND $Event_Data->EventStartDate > date('Y-m-d')  AND $Related_Buyer->Attand_or_not =='1') {
?>
                    <tr>
                        <td><?php echo $i; ?></td>
