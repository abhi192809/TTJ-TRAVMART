    ...
    <div class="margtoppp-data-form card">
      <div class="table-responsive card-body">
        ...
        <tr>
          ...
          <td>123-456-7890</td>
          <td>Delhi</td>
          <td><i class="fas fa-handshake action-icons"></i> <i class="fas fa-comments action-icons action-icons"></i></td>
          <td>
            <i class="fas fa-edit action-icons" title="Edit"></i>
            <i class="fas fa-eye action-icons" title="View" onclick="showAllSellerData()"></i>
          </td>
        </tr>
