  ...
  <table class="table mt-4" id="dataTable">
    ...
    <tbody>
      <tr>
        ...
        <td>
            <a href="#" class="event-details-button btn-warning btn-icon-split">
            <span class="icon" title="Edit">
                <i class="fas fa-edit action-icons text-white"></i>
            </span>
          </a>
          ...
          <a href="#" class="event-details-button btn-success btn-icon-split">
            <span class="icon" title="Update">
                <i class="fas fa-sync-alt action-icons text-white"></i>
            </span>
          </a>
