...
class Buyer extends CI_Controller
{
     public function __construct()
    {
        ...
        // Check if user is not logged ins
    ...
    public function index()
    {
        ...
        $this->load->view('Meeting/Staff-markating/buyer_view', $data);  // Pass $data as an array
    ...
    public function buyer_data_view(){
        ...
        $this->load->view('Meeting/Staff-markating/sidebar');
        $this->load->view('Meeting/Staff-markating/topbar');
        $this->load->view('Meeting/Staff-markating/buyer_data_view',$data);
        $this->load->view('Meeting/Staff-markating/footer');
    ...
    public function buyer_ragistation_appreal_request(){
        ...
        $this->load->view('Meeting/Staff-markating/sidebar');
        $this->load->view('Meeting/Staff-markating/topbar');
        $this->load->view('Meeting/Staff-markating/buyer_ragistation_appreal_request',$data);
        $this->load->view('Meeting/Staff-markating/footer');
    }
    public function buyer_data_old_Event(){
        ...
        $this->load->view('Meeting/Staff-markating/sidebar');
        $this->load->view('Meeting/Staff-markating/topbar');
        $this->load->view('Meeting/Staff-markating/old_buyer_data',$data);
        $this->load->view('Meeting/Staff-markating/footer');
    ...
    public function update_buyer_data(){
        ...
        $this->load->view('Meeting/Staff-markating/sidebar');
        $this->load->view('Meeting/Staff-markating/topbar');
        $this->load->view('Meeting/Staff-markating/Update_buyer_data',$data);
        $this->load->view('Meeting/Staff-markating/footer');
    ...
    public function delete_buyer_data() {
     ...
     public function approve_registration(){
        ...
        $result = $this->Buyer_model->approve_buyer_entry($BuyerId,$EventId);
        $result = $this->Buyer_model->delete_buyer_entry($BuyerId,$EventId);
